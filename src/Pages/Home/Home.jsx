    ...
    <div className="home-container-wrapper">
      <div id="home" className="home-container">
        <div className='left-container'>
          <span><FaFire />New Summer Collection</span>
          
          <div className="description">
              <h1>Discover Quality</h1>
              <h1>Products at the</h1>
              <h1>Best Prices</h1>
              <p>Curated collections for your modern lifestyle. Elevate your home and style with our hand-picked selection of premium goods.</p>
          </div>
